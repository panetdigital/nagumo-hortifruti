...
export default {
  ...
  head: {
    titleTemplate: '%s - nagumo-hortifruti',
    title: 'nagumo-hortifruti',
    htmlAttrs: {
      lang: 'pt-br'
    },
    meta: [
  ...
  css: [
    ...
    // Outros estilos CSS do seu projeto
  ],
  ...
  pwa: {
    manifest: {
      ...
      icons: [
        {
          src: '/logo_192.png', // Caminho para o ícone na pasta estática
          sizes: '192x192',
          type: 'image/png',
        },
        {
          src: '/logo_512.png', // Caminho para o ícone na pasta estática
          sizes: '512x512',
          type: 'image/png',
        },
      ],
